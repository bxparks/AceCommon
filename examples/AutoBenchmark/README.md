...
|---------------------------+-------------------------+---------|
| /1000                     |  37.400/ 37.504/ 37.712 |    1000 |
| udiv1000()                |  15.528/ 15.573/ 15.656 |    1000 |
+---------------------------+-------------------------+---------+
...
| AceCommon function        |     min/    avg/    max | loopCnt |
|---------------------------+-------------------------+---------|
| /1000                     |  37.596/ 37.608/ 37.616 |    1000 |
| udiv1000()                |  15.620/ 15.621/ 15.624 |    1000 |
+---------------------------+-------------------------+---------+
...
| AceCommon function        |     min/    avg/    max | loopCnt |
|---------------------------+-------------------------+---------|
| /1000                     |   3.792/  3.792/  3.793 |    5000 |
| udiv1000()                |   0.103/  0.103/  0.104 |    5000 |
+---------------------------+-------------------------+---------+
...
| udiv1000()                |   0.056/  0.056/  0.058 |   10000 |
+---------------------------+-------------------------+---------+
...
| /1000                     |   0.000/  0.021/  0.065 | 1000000 |
+---------------------------+-------------------------+---------+
